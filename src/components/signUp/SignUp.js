...
function SignUp() {
  ...
  function onKeyUp(e) {
    if (e.charCode === 13) onClickPostSignUp();
  }
        ...
        <div className="bg-soft-primary">
          <div className="row">
            <div className="col-7 col">
              <div className=" p-4">
                <h5>Free Register</h5>
                <p>Get your free Tiko account now.</p>
              </div>
            </div>
        ...
        <div className="card-body">
          ...
          <Form onKeyPress={onKeyUp}>
            <FormGroup>
              ...
              />
              {invalidValue.email && <FormText>This field is invalid</FormText>}
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                className={classNames({
                  "invalid-border": invalidValue.username,
                })}
              />
              {invalidValue.username && (
                <FormText>This field is invalid</FormText>
              )}
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                required
                className={classNames({
                  "invalid-border": invalidValue.password,
                })}
              />
            ...
            <div className="mt-4 text-center">
              <p>
                ...
                <a className="font-weight-medium" href="/signin">
                  {" "}
                  Login
                </a>
              </p>
